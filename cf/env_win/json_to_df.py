...
for root, dirs, files in os.walk(data_json_path):
    ...
    # to csv
    df_playlists_info.to_csv(r'../../data_csv/env_win/playlists_info.csv', index=None)
    df_tracks.to_csv(r'../../data_csv/env_win/tracks.csv', index=None)
    df_playlist_tracks.to_csv(r'../../data_csv/env_win/playlist_tracks.csv', index=None)
